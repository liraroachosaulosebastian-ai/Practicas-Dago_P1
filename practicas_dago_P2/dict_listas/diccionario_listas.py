...
for i in pais1:
    print(f"{i}={pais1[i]}")
# Agregar un atributo a un objeto
pais1["moneda"] = "Peso Mexicano"
print("\nDespués de agregar 'moneda':")
for i in pais1:
    print(f"{i}={pais1[i]}")

# Modificar un valor de un item o atributo que ya existe
pais1["capital"] = "Ciudad de México"
print("\nDespués de modificar 'capital':")
for i in pais1:
    print(f"{i}={pais1[i]}")

# Quitar el último atributo de un objeto
pais1.popitem()
print("\nDespués de quitar el último atributo nuevamente:")
for i in pais1:
    print(f"{i}={pais1[i]}")

# Quitar un atributo en específico de un objeto
pais1.pop("idioma")
print("\nDespués de quitar atributo 'idioma':")
for i in pais1:
    print(f"{i}={pais1[i]}")
